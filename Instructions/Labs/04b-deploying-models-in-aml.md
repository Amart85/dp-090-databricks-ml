...
1. If you have already created an Azure Machine Learning workspace in your subscription, you can skip to the section [Exercise: Deploying Models in Azure Machine Learning](#Exercise-Deploying-Models-in-Azure-Machine-Learning).
