...
1. Download the following notebook file to your local computer, saving it as **Spark-ML-hyperparameters.ipynb** in any folder.

   - https://github.com/MicrosoftLearning/dp-090-databricks-ml/raw/master/notebooks/Spark-ML-hyperparameters.ipynb
...
1. Select the imported **Spark-ML-hyperparameters.ipynb** notebook to open it.
