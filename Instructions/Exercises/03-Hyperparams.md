...
1. Download the following notebook file to your local computer, saving it as **Hyperopt.ipynb** in any folder.

   - [https://github.com/MicrosoftLearning/dp-090-databricks-ml/raw/master/notebooks/Hyperopt.ipynb](https://github.com/MicrosoftLearning/dp-090-databricks-ml/raw/master/notebooks/Hyperopt.ipynb)
...
1. On the **Import Notebooks** dialog, import the **Hyperopt.ipynb** notebook file you downloaded.
1. Select the imported **Hyperopt.ipynb** notebook to open it.
